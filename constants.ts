...
export const WALLS: WallConfig[] = [
  ...
  {
    side: WallSide.EAST,
    imageUrl: '/dezoomify-result East Small.png',
    lowResUrl: '/dezoomify-result East Small.png',
    width: ROOM_DEPTH,
    height: ROOM_HEIGHT,
  ...
  {
    side: WallSide.WEST,
    imageUrl: '/dezoomify-result West2.png',
    lowResUrl: '/dezoomify-result West2.png',
    width: ROOM_DEPTH,
    height: ROOM_HEIGHT,
    position: [-ROOM_WIDTH / 2, ROOM_HEIGHT / 2, 0],
    rotation: [0, Math.PI / 2, 0]
