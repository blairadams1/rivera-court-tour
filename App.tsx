  ...
  return (
    <div className="relative w-full h-screen bg-[#050505] text-white select-none overflow-hidden">
      ...
      {!isAdminMode && !showOverlay && (
        <div className="fixed bottom-10 left-10 z-[200] flex flex-col items-center gap-3 pointer-events-none animate-in slide-in-from-bottom-10 duration-700" style={{ width: '153px' }}>
