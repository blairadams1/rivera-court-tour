        ...
        <div className="fixed bottom-10 left-10 z-[200] flex flex-col gap-4 pointer-events-none animate-in slide-in-from-bottom-10 duration-700">
          <div className="flex items-center gap-6">
            ...
            <button 
              ...
              className={`pointer-events-auto w-11 h-11 rounded-full flex items-center justify-center transition-all border shadow-[0_10px_40px_rgba(0,0,0,0.6)] ${hotspotsVisible ? 'bg-zinc-800 text-white border-white/5 hover:bg-zinc-700' : 'bg-white text-[#005e99] border-white'}`}
